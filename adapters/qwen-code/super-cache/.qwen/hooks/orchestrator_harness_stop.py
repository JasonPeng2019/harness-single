#!/usr/bin/env python3
"""Qwen Code worker Stop hook wrapper.
...
and translates that decision into the Qwen Code Stop hook output contract.
Qwen Code passes the hook input as JSON on stdin, so main() reads stdin
before emitting exactly one JSON object on stdout.
"""
