...
class FirmwareAcceptanceKitTests(unittest.TestCase):
    ...
    def _limitation_evidence(self, root: Path, *, limitation_id: str = "L-1") -> tuple[AcceptanceBroker, Path, dict[str, object]]:
        ...
        status = {"schema":"orchestrator-lane-controller/v1","invocation_schema":"orchestrator-coding-invocation/v1","state":"CODEX_EXITED","exit_code":0,"declared_lane_id":lane,"worker_invocation_id":worker,"held_resource_claims":[],"result_valid":True,"result_validation":{"state":"VALID","path":str(result_path),"sha256":result_ref["sha256"],"commit":repo.head},"controller_pid":1,"controller_started_utc":"2026-01-01T00:00:00Z","controller_created_utc":"2026-01-01T00:00:00Z","repository":repo.declaration(),"worktree_root":str(repo.root)}
